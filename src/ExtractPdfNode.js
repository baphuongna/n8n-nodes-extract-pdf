        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error instanceof Error) {
                    throw new n8n_workflow_1.NodeOperationError(this.description.name, node, `Error extracting text from PDF: ${error.message}`);
                }
                else {
                    throw new n8n_workflow_1.NodeOperationError(this.description.name, node, `Error extracting text from PDF: ${String(error)}`);
                }
            }
        });
    }
